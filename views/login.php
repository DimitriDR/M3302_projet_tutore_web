    ...
    <main class="container">
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <p>Vous n'avez pas de compte ? <a href="register.php">Incrivez-vous</a>.</p>
                <form method="POST" action="/controllers/login.php" class="row g-3">
                    ...
                    <div class="col-12">
                        <button name="submit" id="submit" class="btn btn-primary"><i class="fas fa-sign-in-alt fs-xs"></i> Connexion</button>
                    </div>
                </form>
            </div>
        </div>
